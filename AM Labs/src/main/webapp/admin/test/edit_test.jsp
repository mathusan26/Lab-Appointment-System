				...
				<div class="card my-card">
					<div class="card-header text-center text-white my-bg-color">
						...
						<p class="fs-4 text-center text-white mt-2">
							<i class="fa-solid fa-vial-virus"></i> Edit Test
						</p>
					</div>
					<div class="card-body">
						...
						<form action="../../updateTest" method="post">
							...
							<div class="mb-3">
								<label class="form-label">Test Description</label> <input
									...
									class="form-control" value="<%=test.getTestDescription()%>">

							</div>
							<div class="mb-3">
								<label class="form-label">Price</label> <input
									name="price" type="number" step="any" placeholder="Enter Test Price"
									class="form-control" value="<%=test.getPrice()%>">
