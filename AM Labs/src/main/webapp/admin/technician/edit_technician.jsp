				...
				<div class="card my-card">
					<div class="card-header text-center text-white my-bg-color">
						...
						<p class="fs-4 text-center text-white mt-2">
							<i class="fa-solid fa-user-doctor"></i> Edit Technician Details
						</p>
					</div>
					<div class="card-body">
						...
						<form action="../../updateTechnician" method="post">
							<div class="mb-3">
								<label class="form-label">Technician Name</label> <input
									...
									class="form-control" value="<%=tech.getTechnicianName()%>">
							...
							<div class="mb-3">
								<label class="form-label">Age</label> <input
									name="age" type="number" value="<%=tech.getAge()%>" placeholder="Enter Age"
									class="form-control">

							</div>
							<div class="mb-3">
								<label class="form-label">Phone</label> <input
									name="phone" type="number" value="<%=tech.getPhone()%>" placeholder="Enter Phone Number"
									class="form-control">
							...
							<div class="mb-2">
								<label class="form-label">Address</label> <textarea
									name="address" class="form-control"><%=tech.getAddress()%></textarea>
							</div>
							<!-- for update data of specific user's id used "hidden" id -->
							<div class="mb-3">
								<input name="technicianId" type="hidden" class="form-control"
									value="<%=tech.getId()%>">
							</div>
